...
const TIPO_INFO = {
  ...
  n14: { label: 'Última parcela paga',            icon: '🎉', desc: 'Avisa quando a última parcela de um parcelado vence hoje, liberando o valor no orçamento' },
  n15: { label: 'Saldo abaixo do mínimo',         icon: '🔴', desc: 'Alerta quando o saldo global cai abaixo do valor mínimo configurado' },
  n16: { label: 'Resumo das caixinhas (dia 1)',   icon: '🎯', desc: 'No início do mês: progresso de todas as metas e caixinhas com barra visual' },
  n17: { label: 'Balanço da metade do mês',       icon: '📊', desc: 'No dia 15: projeção de como o orçamento vai fechar com base nos gastos até então' },
};
