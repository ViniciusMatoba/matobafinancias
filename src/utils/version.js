...
export const CHANGELOG = [
  {
    ...
    date: '24/09/2026',
    changes: [
      'Banner sobra segura: exibe data e valor do menor saldo projetado no período; quando o mínimo é hoje, informa que não há despesas fixas previstas no período',
    ],
  },
  {
    version: '1.6.131',
  ...
  },
  {
    ...
    date: '05/08/2026',
    changes: [
      'Fix Projeção: removido historical:true do cálculo de saldo inicial — restaura consistência com o saldo exibido na Home (mantém wInitials das carteiras)',
    ],
  },
  {
    version: '1.6.118',
  ...
  },
  {
    ...
    date: '23/06/2026',
    changes: [
      'Fix: correção de erro crítico (tela preta) causado por recursão na função fmtVal em BudgetSummaryCard e CartaoFaturaCard',
    ],
  },
  {
    version: '1.6.95',
  ...
  },
  {
    ...
    date: '23/06/2026',
    changes: [
      'Reiniciar Tour: reseta também os banners contextuais por tela (toursVistas), não apenas o tour guiado principal',
    ],
  },
  {
    version: '1.6.93',
    date: '23/06/2026',
    changes: [
      'Onboarding Telegram: aviso de que é necessário ter o Telegram instalado + instrução de download + botão renomeado para "Abrir ou baixar o Telegram"',
    ],
  },
  {
    version: '1.6.92',
  ...
  },
  {
    ...
    date: '23/06/2026',
    changes: [
      'Botão ? de ajuda contextual em todas as 6 telas — abre modal com explicações detalhadas da tela atual',
    ],
  },
  {
    version: '1.6.90',
  ...
  },
  {
    ...
    date: '23/06/2026',
    changes: [
      'Fix bot N14: alerta de última parcela nunca disparava — cálculo de data corrigido para dataInicio + (parcelaAtual-1) meses',
      'Fix bot /cartoes: dias até vencimento mostrava 31 no dia do vencimento — usa getProximoVencimentoBot igual ao frontend',
      'Fix bot /proximas e /previsao: gastos de hoje eram contados duas vezes no saldo esperado — expandRange agora começa em amanhã',
    ],
  },
  {
    version: '1.6.81',
